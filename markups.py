...
main_menu_markup.add(types.InlineKeyboardButton(text='🛠Техподдержка', url='https://t.me/slbdev'), types.InlineKeyboardButton(text='💻Исходный код', url='https://github.com/theslothbear/emailed'))
